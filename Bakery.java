...
public class Bakery implements Lock {
    ...
    AtomicIntegerArray choosing = new AtomicIntegerArray(threads); //need this for non-atomic max selection
    private int tid;
    ...
    public void lock()
    {
        ...
        for(int i = 0; i < ticket.length(); ++i)
        {
            if(i != tid)
            {
                while(choosing.get(i) == 1){} //wait while other thread picks a ticket
